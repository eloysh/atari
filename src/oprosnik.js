...
function Oprosnik({ formData }) {
    ...
    const [mortgageApproved, setMortgageApproved] = useState(false);
    ...
    const handleMortgageApprovedChange = () => {
        setMortgageApproved(!mortgageApproved);
        handleSendWhatsApp(); // Call handleSendWhatsApp whenever the mortgage approval checkbox changes
    };
                    ...
                    <div className="checkbox-group">
                        <label>
                            <input
                                ...
                                checked={mortgageApproved}
                                onChange={handleMortgageApprovedChange}
                            />
                            Одобрена ипотека
                        </label>
                        <label>
